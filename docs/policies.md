...
- Description: `SAs and nodes that can bind clusterrolebindings or bind rolebindings in the privileged namespaces can grant admin-equivalent permissions to themselves`
- Severity: `Critical`
- Violation types: `serviceAccounts, nodes`
